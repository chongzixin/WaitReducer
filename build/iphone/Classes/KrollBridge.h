...
@interface WaitReducerObject : KrollCoverageObject {
#else
@interface WaitReducerObject : KrollObject {
#endif
@private
...
extern NSString * WaitReducer$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WaitReducerObject *_waitreducer;
    KrollObject* console;
	BOOL shutdown;
