...
/**
 The base class for all WaitReducer modules
 */
...
/**
 WaitReducer Platform calls this method on startup.
 */
-(void)startup;

/**
 WaitReducer Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WaitReducer Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WaitReducer Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 WaitReducer Platform calls this method on resume.
 @param sender The sender of the event.
 */
