...
//@interface WaitReducerObject : NSObject
//@end

@interface WaitReducerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WaitReducerObject class]])
		{
			for (NSString *key in [[(WaitReducerObject*)o modules] allKeys])
			{
