...
// in simulator we redefine to format for WaitReducer Developer console
...
{\
	NSString * exceptionName = [@"org.waitreducer." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.waitreducer";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWaitReducerNativeItemNone = -1, 
	UIWaitReducerNativeItemSpinner = -2,
	UIWaitReducerNativeItemProgressBar = -3,
	
	UIWaitReducerNativeItemSlider = -4,
	UIWaitReducerNativeItemSwitch = -5,
	UIWaitReducerNativeItemMultiButton = -6,
	UIWaitReducerNativeItemSegmented = -7,
	
	UIWaitReducerNativeItemTextView = -8,
	UIWaitReducerNativeItemTextField = -9,
	UIWaitReducerNativeItemSearchBar = -10,
	
	UIWaitReducerNativeItemPicker = -11,
	UIWaitReducerNativeItemDatePicker = -12,
	
	UIWaitReducerNativeItemInfoLight = -13,
	UIWaitReducerNativeItemInfoDark = -14,
	
	UIWaitReducerNativeItemDisclosure = -15,
	
	UIWaitReducerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WaitReducer instances of
