...
/**
 Base class for all WaitReducer views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WaitReducer view hierarchy (such as wrapped iOS UIViews) was touched.
